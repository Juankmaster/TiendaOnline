...
class SLP_UI extends SLPlus_BaseClass_Object {
	...
	protected function initialize() {
		...
		$this->shortcode_map_region = $this->slplus->Country_Manager->countries[ $this->slplus->options_nojs['default_country'] ]->cctld;
	}
